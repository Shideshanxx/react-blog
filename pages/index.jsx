...
const Home = (props) => {
  ...
  return (
    <>
      <Head>
        <title>Asunarail_Blog-网上冲浪的记录站</title>
      </Head>
        ...
        <div className={classnames('wrap content-box')}>
          <Row>
            ...
            <Col xs={0} sm={0} md={0} lg={6} xl={6}>
              ...
              {/* up信息列表 */}
              <Card bordered={false} >
                <p style={{ fontWeight: 'bold', textAlign: 'left' }}>博主</p>
...
// nextjs通过server获取数据添加到props中的方式
export async function getServerSideProps() {
  ...
  const promise3 = new Promise((resolve) => {
    request(serviceApi.getYitu, {
      ...
      resolve({
        imgurl: '//cdn.zjutshideshan.cn/blog/api_err_img.png',
        ciba: '快去告诉站主，每日一句的接口炸了！'
      })
    })
  })
